...
const WhatsAppButton = () => (
  <a
    href="https://wa.me/553884110229?text=Quero%20saber%20mais%20sobre%20o%20T3%20Hub"
    target="_blank"
    rel="noopener noreferrer"
    aria-label="Fale conosco no WhatsApp"
    className="whatsapp-float fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 rounded-full bg-[#25D366] shadow-lg shadow-black/40 hover:scale-110 hover:bg-[#20BD5A] transition-all duration-300"
  >
    <svg viewBox="0 0 32 32" className="w-9 h-9 fill-white">
      <path d="M16.004 3.2c-7.07 0-12.8 5.73-12.8 12.8 0 2.26.59 4.37 1.62 6.2L3.2 28.8l6.77-1.78a12.75 12.75 0 0 0 6.03 1.54h.01c7.07 0 12.8-5.73 12.8-12.8s-5.73-12.56-12.8-12.56zm0 23.31h-.01a10.5 10.5 0 0 1-5.35-1.47l-.38-.23-3.98 1.05 1.06-3.88-.25-.4a10.47 10.47 0 0 1-1.6-5.58c0-5.8 4.72-10.51 10.52-10.51 2.81 0 5.45 1.1 7.43 3.08a10.44 10.44 0 0 1 3.08 7.43c0 5.8-4.72 10.51-10.52 10.51zm5.77-7.87c-.32-.16-1.88-.93-2.17-1.03-.29-.11-.5-.16-.71.16-.21.32-.82 1.03-1 1.24-.19.21-.37.24-.69.08-.32-.16-1.34-.49-2.55-1.57-.94-.84-1.58-1.87-1.76-2.19-.19-.32-.02-.49.14-.65.14-.14.32-.37.48-.55.16-.19.21-.32.32-.53.11-.21.05-.4-.03-.56-.08-.16-.71-1.71-.97-2.34-.26-.62-.52-.53-.71-.54-.18-.01-.4-.01-.61-.01s-.56.08-.85.4c-.29.32-1.11 1.08-1.11 2.63s1.14 3.05 1.3 3.26c.16.21 2.24 3.42 5.43 4.79.76.33 1.35.53 1.81.68.76.24 1.45.21 2 .13.61-.09 1.88-.77 2.14-1.51.27-.75.27-1.38.19-1.51-.08-.13-.29-.21-.61-.37z"/>
    </svg>
  </a>
);
